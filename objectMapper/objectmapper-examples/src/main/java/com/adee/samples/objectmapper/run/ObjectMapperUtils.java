...
public class ObjectMapperUtils {
	...
	public static void createJsonNodeStr() throws IOException {
		...
		Country countryFromFile = objectMapper.readValue(new File("random.json"), Country.class);
		array.addPOJO(country);
		array.addPOJO(countryFromFile);
		System.out.println("createJsonNodeStr " + objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(root));
	}
